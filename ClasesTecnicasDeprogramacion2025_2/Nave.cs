...
inventario.AgregarSuministro("ropa");
...
do
{
    ...
    Console.WriteLine("5. Borrar inventario");
    Console.WriteLine("6. Invertir inventario");
    ...
    switch (opcion)
    {
        case 1:
            ...
            Console.WriteLine("Nombre del suminstro:  ");
            string nombre  = Console.ReadLine() ?? "";
            Console.WriteLine("Desear añidir prioridad y cantidad y/n?");
            char respuesta = char.Parse(Console.ReadLine() ?? "");
            if( respuesta == 'y')
            {
                Console.WriteLine("Cantidad de suminstro: ");
                int cantidad = int.Parse(Console.ReadLine() ?? "");
                Console.WriteLine("Prioridad del sumisntro ");
        ...
        case 2:
            ...
            inventario.BuscarSuministros(nombreB);
            break;
        case 3:
        ...
        case 4:
            ...
            break;
        case 5:
            Console.WriteLine("Ordernar por nombre ...");
            inventario.OrdenarPorNombre(); 
            orden = true;
            break;
        case 6:
            Console.WriteLine("Invertiendo el inventario...");
